...
export const usePatientStore = defineStore('patient', {
    ...
    actions: {
      async getPIN(id: string) {
        ...
        try {
          const response = await fetch(`https://serv.resultadosyaminacumplido.com/webhook/2755cc81-5d0f-4852-931c-921309c5d5c7`, {
            method: 'POST',
            headers: {
      ...
      async validatePIN(pin:string) {
        ...
        try {
          const response = await fetch(`https://serv.resultadosyaminacumplido.com/webhook/556af0dd-5193-4fe4-b8cb-913f2a8e8978`, {
            method: 'POST',
            headers: {
      ...
      async downloadFile(code:string) {
        ...
        try {
          const response = await fetch(`https://serv.resultadosyaminacumplido.com/webhook/58d79f60-287c-41ba-8cfe-cc05202c75a0`, {
            method: 'POST',
            headers: {
